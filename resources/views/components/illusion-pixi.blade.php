<a class="illusion" href="/illusions/pixi/1">
    <div class="image">
        <span class="banner">
            <span class="animate">PixiJS</span>
        </span>
        <img src="{{ asset('storage/pixi/thumbnail.png') }}" alt="illusion name" class="object-cover w-full h-full" loading="lazy">
        <div class="hover">
